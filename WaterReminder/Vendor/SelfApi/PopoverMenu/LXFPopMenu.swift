...
class LXFPopMenu: UIView {
    ...
    lazy var menuContainerView: UIImageView = { [unowned self] in
        ...
        let img = UIImage.generateImageWithColor(color:#colorLiteral(red: 0.441578418, green: 0.7487869859, blue: 0.990054667, alpha: 1))
        let container = UIImageView(image: img.resizableImage(withCapInsets: UIEdgeInsetsMake(30, 10, 30, 50), resizingMode: .tile))
